...
$CC -I$LIB_DIR/include -T $LINKER_SCRIPT -Xlinker -Map=output.map -g -static -O0 -march=rv32i -mabi=ilp32 -nostartfiles --specs=nosys.specs -o $1.riscv $LIB_DIR/start.S $LIB_DIR/syscalls.c $LIB_DIR/startup.c $LIB_DIR/tinyalloc/tinyalloc.c "${@:2}"
# Generate dump file.
